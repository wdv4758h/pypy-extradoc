...
Furthermore, to test the technique on a more realistic example, we did some
...
\ref{fig:bench-example}. The function is a bit arbitrary but executing it is
...
function significantly, even outperforming CPython by a bit. The tracer needs to
