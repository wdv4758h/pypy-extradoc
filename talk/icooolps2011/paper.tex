...
\begin{itemize}
 ...
 \item A way to annotate operations as pure which the constant folding
...
pure operations on these constants can be constant-folded. This works well for
...
\cfbolz{XXX mention a possible debug mode for findings bugs in this, or too many values in promotion. stress more that promote is safe}
