...
return (y>=this.offset.y&&y<this.offset.y+_822.offsetHeight&&x>=this.offset.x&&x<this.offset.x+_822.offsetWidth);
},withinIncludingScrolloffsets:function(_823,x,y){
var _824=this.realOffset(_823);
this.xcomp=x+_824.x-this.windowOffset.x;
this.ycomp=y+_824.y-this.windowOffset.y;
this.offset=this.cumulativeOffset(_823);
return (this.ycomp>=this.offset.y&&this.ycomp<this.offset.y+_823.offsetHeight&&this.xcomp>=this.offset.x&&this.xcomp<this.offset.x+_823.offsetWidth);
},overlap:function(mode,_826){
if(!mode){
return 0;
}
if(mode=="vertical"){
return ((this.offset.y+_826.offsetHeight)-this.ycomp)/_826.offsetHeight;
}
if(mode=="horizontal"){
return ((this.offset.x+_826.offsetWidth)-this.xcomp)/_826.offsetWidth;
}
},absolutize:function(_827){
_827=MochiKit.DOM.getElement(_827);
if(_827.style.position=="absolute"){
return;
}
MochiKit.Position.prepare();
var _828=MochiKit.Position.positionedOffset(_827);
var _829=_827.clientWidth;
var _830=_827.clientHeight;
var _831={"position":_827.style.position,"left":_828.x-parseFloat(_827.style.left||0),"top":_828.y-parseFloat(_827.style.top||0),"width":_827.style.width,"height":_827.style.height};
_827.style.position="absolute";
_827.style.top=_828.y+"px";
_827.style.left=_828.x+"px";
_827.style.width=_829+"px";
_827.style.height=_830+"px";
return _831;
},positionedOffset:function(_832){
var _833=0,valueL=0;
do{
_833+=_832.offsetTop||0;
valueL+=_832.offsetLeft||0;
_832=_832.offsetParent;
if(_832){
p=MochiKit.DOM.getStyle(_832,"position");
if(p=="relative"||p=="absolute"){
break;
}
}
}while(_832);
return new MochiKit.Style.Coordinates(valueL,_833);
},relativize:function(_834,_835){
_834=MochiKit.DOM.getElement(_834);
if(_834.style.position=="relative"){
return;
}
MochiKit.Position.prepare();
var top=parseFloat(_834.style.top||0)-(_835["top"]||0);
var left=parseFloat(_834.style.left||0)-(_835["left"]||0);
_834.style.position=_835["position"];
_834.style.top=top+"px";
_834.style.left=left+"px";
_834.style.width=_835["width"];
_834.style.height=_835["height"];
},clone:function(_838,_839){
_838=MochiKit.DOM.getElement(_838);
_839=MochiKit.DOM.getElement(_839);
_839.style.position="absolute";
var _840=this.cumulativeOffset(_838);
_839.style.top=_840.y+"px";
_839.style.left=_840.x+"px";
_839.style.width=_838.offsetWidth+"px";
_839.style.height=_838.offsetHeight+"px";
},page:function(_841){
var _842=0;
var _843=0;
var _844=_841;
do{
_842+=_844.offsetTop||0;
_843+=_844.offsetLeft||0;
if(_844.offsetParent==document.body&&MochiKit.DOM.getStyle(_844,"position")=="absolute"){
break;
}
}while(_844=_844.offsetParent);
_844=_841;
do{
_842-=_844.scrollTop||0;
_843-=_844.scrollLeft||0;
}while(_844=_844.parentNode);
return new MochiKit.Style.Coordinates(_843,_842);
}};
if(typeof (dojo)!="undefined"){
...
MochiKit.DragAndDrop.Droppables={drops:[],remove:function(_845){
this.drops=MochiKit.Base.filter(function(d){
return d.element!=MochiKit.DOM.getElement(_845);
},this.drops);
...
},prepare:function(_847){
MochiKit.Base.map(function(drop){
if(drop.isAccepted(_847)){
if(drop.options.activeclass){
MochiKit.DOM.addElementClass(drop.element,drop.options.activeclass);
}
drop.options.onactive(drop.element,_847);
}
},this.drops);
},findDeepestChild:function(_848){
deepest=_848[0];
for(i=1;i<_848.length;++i){
if(MochiKit.DOM.isParent(_848[i].element,deepest.element)){
deepest=_848[i];
}
}
return deepest;
},show:function(_849,_850){
...
(function(){
var _975=MochiKit.Base.extend;
var self=MochiKit.MochiKit;
var _976=self.SUBMODULES;
var _977=[];
var _978=[];
var _979={};
var i,k,m,all;
...
m=MochiKit[_976[i]];
_975(_977,m.EXPORT);
_975(_978,m.EXPORT_OK);
for(k in m.EXPORT_TAGS){
_979[k]=_975(_979[k],m.EXPORT_TAGS[k]);
}
all=m.EXPORT_TAGS[":all"];
if(!all){
all=_975(null,m.EXPORT,m.EXPORT_OK);
}
var j;
...
var _980=document.getElementsByTagName("script");
var _981="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul";
var base=null;
var _982=null;
var _983={};
var i;
for(i=0;i<_980.length;i++){
var src=_980[i].getAttribute("src");
if(!src){
continue;
}
_983[src]=true;
...
var _984=MochiKit.MochiKit.SUBMODULES;
for(var i=0;i<_984.length;i++){
if(MochiKit[_984[i]]){
continue;
}
var uri=base+_984[i]+".js";
if(uri in _983){
continue;
}
if(document.documentElement&&document.documentElement.namespaceURI==_981){
var s=document.createElementNS(_981,"script");
s.setAttribute("id","MochiKit_"+base+_984[i]);
s.setAttribute("src",uri);
s.setAttribute("type","application/x-javascript");
_982.parentNode.appendChild(s);
}else{
