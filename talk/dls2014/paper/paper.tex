...
\emph{Atomic blocks}~\cite{tim03,tim05} would allow dynamic languages to
...
each object, this code is called at most once per minor collection.
...
(GIL), PyPy with STM, and PyPy with the GIL (all without the JIT). The
...
our operating systems.  Unfortunately, processor architects seem to
