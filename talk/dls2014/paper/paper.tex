...
(GC)} that is closely integrated with the TM part.
...
by each thread ($12.3\%$ for all 4 threads together). While this
is not ideal, we think that $12.3\%$ are acceptable on four
...
that it is $\approx 43.3\%$. The maximum in richards is
$71\%$. In all benchmarks \emph{pypy-stm-nojit} beats
